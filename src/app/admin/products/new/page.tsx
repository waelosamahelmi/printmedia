  ...
  const handleSubmit = async (e: React.FormEvent, publish = false) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        const data = await res.json()
        setError(data.error || 'Tuotteen luonti epäonnistui')
      }
    } catch (err) {
      setError('Tuotteen luonti epäonnistui')
    } finally {
      setLoading(false)
    }
  }
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Uusi tuote</h1>
            <p className="text-gray-600">Luo uusi tuote</p>
          </div>
        </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="flex items-center gap-2 cursor-pointer">
                  ...
                  />
                  <span className="text-sm font-medium text-gray-700">Nostetttu tuote</span>
                </label>
              </div>
            </div>
          </div>
