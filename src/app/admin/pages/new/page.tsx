  ...
  const handleSubmit = async (e: React.FormEvent, publish = false) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setError(data.error || 'Sivun luonti epäonnistui')
      }
    } catch (err) {
      setError('Sivun luonti epäonnistui')
    } finally {
      setLoading(false)
    }
  }
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Uusi sivu</h1>
            <p className="text-gray-600">Luo uusi sivu</p>
          </div>
        </div>
